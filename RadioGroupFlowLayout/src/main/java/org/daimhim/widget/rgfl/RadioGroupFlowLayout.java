package org.daimhim.widget.rgfl;
 ...
 * ━━━━━━感觉萌萌哒━━━━━━
 *
 * Created by Daimhim on 2017/4/6.
 */
public class RadioGroupFlowLayout extends LinearLayout {
    ...
    public RadioGroupFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.RadioGroupFlowLayout, defStyle, 0);
        final boolean checked = a.getBoolean(
                R.styleable.RadioGroupFlowLayout_checked, false);
        a.recycle();
        setChecked(checked);
        init();
    }
